...
export default function EditSDSForm() {
    ...
    const handleSave = () => {
        console.log('Updating SDS data:', form);
        ...
        toast.current?.show({ 
            severity: 'success', 
            summary: 'Success', 
            detail: 'SDS data updated successfully' 
        });
            ...
            <div className="container">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="border rounded p-4 bg-gray-50 flex flex-col items-center justify-center" style={{ minHeight: '300px' }}>
                            <div className="text-center mb-4">
                                <div className="text-6xl text-red-500 mb-2">✕</div>
                                <div className="text-gray-600">No file uploaded</div>
                            </div>
                            <div className="flex gap-2">
                                <Button label="Download" className="p-button-primary" disabled={!uploadSdrReport} />
                                <input
                    ...
                    <div className="mb-6">
                        <div className="flex items-center justify-between mb-3">
                            <h3 className="font-semibold text-lg">3. SDS (2) : Sample Data Sheet (2)</h3>
